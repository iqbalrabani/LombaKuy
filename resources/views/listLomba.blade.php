...
<body>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-custom sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="/yourCompetition/{{ $namePengguna }}/{{ $idPen }}">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <br>
                        <h1 class="mb-4 text-gray-800">List of Ongoing Competitions</h1>
                        <br>
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/applyCompetition/{{ $idPen }}/{{ $m->idLomba }}" class='btn btn-custom'>Apply</a>
